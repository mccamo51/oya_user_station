...
class SearchPorter extends StatefulWidget {
  @override
  _SearchPorterState createState() => _SearchPorterState();
}

class _SearchPorterState extends State<SearchPorter> {
  String _searchText = "";
  ...
  Widget _mRoute(PortersModel model, BuildContext context) {
