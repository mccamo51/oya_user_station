...
import 'package:oya_porter/models/busSeatsModel.dart';
import 'package:oya_porter/pages/admin/tickets/widgets/seatSelectionWidget.dart';
import '../../../spec/colors.dart';

List<Map<String, dynamic>> otherPassanger = <Map<String, dynamic>>[];

List<int> seatSelectedId = <int>[];
List<int> seatSelectedIdTemp = <int>[];

class SeatSelection extends StatefulWidget {
  final String busId, station;
  // final String totalSeat, busModel; String price, tripDate, tripTime, route;
...
class _SeatSelectionState extends State<SeatSelection> {
  ...
  String seatSelectedName, seatId;
      ...
      bottomNavigationBar: seatSelectionButtonWidget(
        onPressed: () {
          if (seatSelectedId == null) {
            ...
            toastContainer(text: "${seatSelectedId[0]}");
            Navigator.pop(context, seatId);
          }
        },
        details: " (${seatSelectedId}) Seater",
        onAddOther: () {
                            ...
                            busSeatsModelList.busSeatsModelList[x].status == 1
                                ...
                                : () {
                                    ...
                                    setState(() {
                                      ...
                                      seatId =
                                          "${busSeatsModelList.busSeatsModelList[x].id}";
