...
import 'package:oya_porter/pages/Users/bloc/parcelRecievedBloc.dart';
...
class _ParcelRecievedState extends State<ParcelRecieved> {
  ...
  @override
  void initState() {
    parcelRecievedBloc.fetchAllParcelRecieved(context);
    ...
    return Scaffold(
      ...
      body: _internet
          ? RefreshIndicator(
              ...
              child: StreamBuilder(
                ...
                initialData: loadParcelRecievedMapOffline == null
                    ? null
                    : ParcelRecievedModel.fromJson(
                        loadParcelRecievedMapOffline),
                builder:
          ...
          : loadParcelRecievedMapOffline == null
              ...
              : _mainContent(
                  ParcelRecievedModel.fromJson(ticketFromMapOffline),
                ),
    );
  }
