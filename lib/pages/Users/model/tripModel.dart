class TripsModel {
  ...
  TripsModel({this.status, this.message, this.data});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    specialUserId = json['special_user_id'].toString();
    manifestCode = json['manifest_code'].toString();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['special_user_id'] = this.specialUserId;
    data['manifest_code'] = this.manifestCode;
